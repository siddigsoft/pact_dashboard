...
import '../screens/enhanced_call_screen.dart';
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        ...
                        if (mounted) {
                          final callScreen = widget.useEnhancedScreen
                              ? EnhancedCallScreen(
                          ...
                          navigator.push(
                            MaterialPageRoute(builder: (ctx) => callScreen),
                          );
                        }
                      },
                      child: Container(
