...
class CostApprovalCard extends StatelessWidget {
  ...
  final int approvalTier; // 1, 2, or 3
  final bool isArabic;
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if (submission.vendor != null)
                      _DetailChip(icon: Icons.store, label: submission.vendor!),
                    _DetailChip(
                      icon: Icons.person,
...
class PendingApprovalsBadge extends StatelessWidget {
  ...
  const PendingApprovalsBadge({super.key, required this.count, this.onTap});
