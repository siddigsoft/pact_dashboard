...
class _AdvanceReceiptConfirmationDialogState
  ...
  Future<void> _confirmReceipt() async {
    ...
    try {
      ...
      final existingRc =
          existingMetadata['receipt_confirmation'] as Map<String, dynamic>?;
      ...
      final signatureHash = _generateHash(
        '$signatureId:${user.id}:${widget.requestId}:$now',
      );
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isArabic
                                ? 'تأكيد استلام أموال السلفة'
                                : 'Confirm advance funds received',
                            style: GoogleFonts.poppins(
                              fontSize: 12,
