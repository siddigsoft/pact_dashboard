...
const List<SudaneseBank> kSudaneseBanks = [
  ...
  SudaneseBank(nameEn: 'Omdurman National Bank', nameAr: 'بنك أمدرمان الوطني'),
  ...
  SudaneseBank(nameEn: 'Al Baraka Bank Sudan', nameAr: 'مصرف البركة السودان'),
  SudaneseBank(
  ...
  SudaneseBank(nameEn: 'El Nilein Bank', nameAr: 'بنك النيلين'),
  SudaneseBank(
    nameEn: 'Emirates and Sudan Bank',
    nameAr: 'بنك الإمارات والسودان',
  ),
  SudaneseBank(nameEn: 'Family Bank', nameAr: 'بنك الأسرة'),
  SudaneseBank(
  ...
  SudaneseBank(nameEn: 'Saudi Sudanese Bank', nameAr: 'البنك السعودي السوداني'),
  SudaneseBank(
  ...
  SudaneseBank(nameEn: 'Tadamon Islamic Bank', nameAr: 'مصرف التضامن الإسلامي'),
  SudaneseBank(nameEn: 'United Capital Bank', nameAr: 'البنك المتحد'),
  SudaneseBank(nameEn: 'Workers National Bank', nameAr: 'بنك العمال الوطني'),
];
