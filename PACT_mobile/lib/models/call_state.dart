...
class CallState {
  ...
  String? get remoteName => _remoteUserName; // Convenience getter
  String? get remoteAvatar => remoteUserAvatar; // Convenience getter
  ...
  CallPriority callPriority = CallPriority.normal;
  String? callReason;
  DateTime? scheduledTime;
  bool isVerified = false;
  String? callerDepartment;
  Map<String, dynamic>? callContext;
  ...
  /// Get CallType enum (video or audio)
  CallType get callTypeEnum => isAudioOnly ? CallType.audio : CallType.video;
