...
class TrackerPreparationPlanScreen extends StatefulWidget {
  ...
  @override
  State<TrackerPreparationPlanScreen> createState() =>
      _TrackerPreparationPlanScreenState();
}

class _TrackerPreparationPlanScreenState
    extends State<TrackerPreparationPlanScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            ReusableAppBar(
              title: 'Tracker Preparation Plans',
              showBackButton: true,
              actions: [
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          height: 42,
          decoration: BoxDecoration(
            color: const Color(0xFF0F2041).withValues(alpha: 0.08),
        ...
        subtitle: Column(
          ...
          children: [
            if (month.isNotEmpty || year != null)
              Text(
                '$month${year != null ? ' $year' : ''}  ·  $targets target sites',
                style: GoogleFonts.poppins(
                  fontSize: 11,
