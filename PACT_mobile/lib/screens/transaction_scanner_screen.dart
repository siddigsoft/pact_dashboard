...
class TransactionScannerScreen extends StatefulWidget {
  ...
  @override
  State<TransactionScannerScreen> createState() =>
      _TransactionScannerScreenState();
}
  ...
  Future<void> _processImage() async {
    ...
    try {
      ...
      final response = await _supabase.functions.invoke(
        'scan-transaction',
        body: {'image_base64': base64Image, 'mime_type': 'image/jpeg'},
      );
                        ...
                        children: [
                          ...
                          if (_dataSource != null)
                            Container(
                              ...
                              child: Text(
                                _dataSource == 'gemini' ? 'Gemini AI' : 'AI',
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () =>
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Data copied — paste into your transaction record',
                                  ),
                                ),
                              ),
