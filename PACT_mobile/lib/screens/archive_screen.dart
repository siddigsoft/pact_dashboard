    ...
    try {
      ...
      if (_activeTab == 'mmps') {
        data = List<Map<String, dynamic>>.from(
          await _supabase.from('monthly_monitoring_plans')
              .select('id, mmp_code, status, month, year')
              .eq('status', 'closed')
        ...
        data = List<Map<String, dynamic>>.from(
          await _supabase.from('site_visits')
              .select('id, status, site_name, visit_date')
            ...
            child: Row(children: [
              for (final tab in _tabs)
                Expanded(child: GestureDetector(
                  onTap: () {
                    setState(() { _activeTab = tab.$1; _items = []; });
                    _loadData();
                  },
                  child: Container(
            ...
            child: _isLoading
                ...
                : filtered.isEmpty
                    ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        const Text('No archived items found.', style: TextStyle(color: Colors.grey)),
                      ]))
                    : RefreshIndicator(
                        onRefresh: _loadData,
                        child: ListView.builder(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                leading: Icon(
                                  _activeTab == 'mmps' ? Icons.assignment : _activeTab == 'visits' ? Icons.map : Icons.description,
