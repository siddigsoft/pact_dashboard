...
final List<SudanState> sudanStates = [
  ...
  SudanState(
    ...
    localities: [
      ...
      Locality(id: 'ks-west-kassala', name: 'West Kassala', nameAr: 'غرب كسلا'),
      Locality(
      ...
      Locality(id: 'ks-nahr-atbara', name: 'Nahr Atbara', nameAr: 'نهر عطبرة'),
      Locality(
...
/// Canonical state IDs used in this file. Backend/profile may use alternate spellings.
/// Maps known aliases to the canonical id so lookups work either way.
...
List<Locality> getLocalitiesByState(String stateId) {
  final id = _normalizeStateId(stateId);
