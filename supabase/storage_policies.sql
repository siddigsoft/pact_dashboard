...
-- Create mmp-files bucket if it doesn't exist
INSERT INTO storage.buckets (id, name, public)
...
-- Drop existing mmp-files policies if they exist (to avoid conflicts)
...
-- ============================================================================
-- MMP FILES STORAGE POLICIES
-- ============================================================================
-- Storage bucket policies for MMP files and coordinator permits
-- This includes monitoring plan files, site visit photos, and coordinator permits
--
-- Created: 2025-11-29
-- ============================================================================

-- Policy: Authenticated users can upload MMP files and permits
-- Any authenticated user can upload files to mmp-files bucket
...
-- Users can view files in the mmp-files bucket
...
-- Users can delete files they uploaded (tracked via folder structure)
-- File path structures:
-- - coordinator-permits/user_id/state_id/locality_id/filename
-- - mmp-files/user_id/filename
-- - site-visit-photos/user_id/filename
