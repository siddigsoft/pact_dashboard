...
-- Self-contained: enum extensions are applied inline (outside DO block)
-- so they auto-commit before the account inserts run.
-- =====================================================================

-- ── Enum extensions (must be OUTSIDE the DO block to auto-commit) ────
