-- Migration: Down-Payment Request System & Super-Admin Role (FIXED TYPE CASTS)
-- Date: 2025-11-25
...
-- ============================================================================
-- 9. RLS POLICIES - Down-Payment Requests (WITH EXPLICIT TYPE CASTS)
-- ============================================================================
...
COMMENT ON TABLE down_payment_requests IS 'Down-payment request system - Migration 20251125 (FIXED)';
COMMENT ON TABLE cost_adjustment_audit IS 'Cost adjustment audit trail - Migration 20251125 (FIXED)';
COMMENT ON TABLE super_admins IS 'Super-admin role with 3-account limit - Migration 20251125 (FIXED)';
COMMENT ON TABLE deletion_audit_log IS 'Deletion audit log - Migration 20251125 (FIXED)';
...
BEGIN
  ...
  RAISE NOTICE '✅ Added RLS policies for all new tables with explicit type casts';
