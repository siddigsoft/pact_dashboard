...
class CallStateNotifier extends StateNotifier<CallStateData> {
  ...
  CallStateNotifier(this._callService, this._backgroundHandler) : super(CallStateData()) {
    _setupListeners();
  }
  ...
  void _setupListeners() {
    ...
    _remoteParticipantSubscription = _callService.remoteParticipantStream.listen((participant) {
    ...
    _incomingCallSubscription = _callService.incomingCallStream.listen((signal) {
    ...
    _backgroundCallSubscription = _backgroundHandler.incomingCallStream.listen((payload) {
...
final callStateProvider = StateNotifierProvider<CallStateNotifier, CallStateData>((ref) {
