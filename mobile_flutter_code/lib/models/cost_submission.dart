...
extension CostRequestTypeExtension on CostRequestType {
  String get value {
    switch (this) {
      case CostRequestType.advance: return 'advance';
      case CostRequestType.reimbursement: return 'reimbursement';
    }
  }
  
  String get labelEn {
    switch (this) {
      case CostRequestType.advance: return 'Advance Payment';
      case CostRequestType.reimbursement: return 'Reimbursement';
    }
  }
  ...
  String get labelAr {
    switch (this) {
      case CostRequestType.advance: return 'دفعة مقدمة';
      case CostRequestType.reimbursement: return 'استرداد';
    }
  }
...
extension CostSubmissionStatusExtension on CostSubmissionStatus {
  ...
  String get labelEn {
    switch (this) {
      case CostSubmissionStatus.pending: return 'Pending';
      case CostSubmissionStatus.underReview: return 'Under Review';
      case CostSubmissionStatus.approved: return 'Approved';
      case CostSubmissionStatus.rejected: return 'Rejected';
      case CostSubmissionStatus.disbursed: return 'Disbursed';
      case CostSubmissionStatus.reconciliationPending: return 'Reconciliation Pending';
      case CostSubmissionStatus.reconciled: return 'Reconciled';
      case CostSubmissionStatus.paid: return 'Paid';
      case CostSubmissionStatus.closed: return 'Closed';
      case CostSubmissionStatus.cancelled: return 'Cancelled';
  ...
  String get labelAr {
    switch (this) {
      case CostSubmissionStatus.pending: return 'قيد الانتظار';
      case CostSubmissionStatus.underReview: return 'قيد المراجعة';
      case CostSubmissionStatus.approved: return 'موافق عليه';
      case CostSubmissionStatus.rejected: return 'مرفوض';
      case CostSubmissionStatus.disbursed: return 'تم الصرف';
      case CostSubmissionStatus.reconciliationPending: return 'تسوية معلقة';
      case CostSubmissionStatus.reconciled: return 'تمت التسوية';
      case CostSubmissionStatus.paid: return 'مدفوع';
      case CostSubmissionStatus.closed: return 'مغلق';
      case CostSubmissionStatus.cancelled: return 'ملغى';
    }
  }
...
extension TierApprovalStatusExtension on TierApprovalStatus {
  String get value {
    switch (this) {
      case TierApprovalStatus.pending: return 'pending';
      case TierApprovalStatus.approved: return 'approved';
      case TierApprovalStatus.rejected: return 'rejected';
      case TierApprovalStatus.changesRequested: return 'changes_requested';
    }
  }
  
  static TierApprovalStatus fromString(String? value) {
    switch (value) {
      case 'pending': return TierApprovalStatus.pending;
      case 'approved': return TierApprovalStatus.approved;
      case 'rejected': return TierApprovalStatus.rejected;
      case 'changes_requested': return TierApprovalStatus.changesRequested;
      default: return TierApprovalStatus.pending;
    }
  }
}
...
extension OperationalExpenseCategoryExtension on OperationalExpenseCategory {
  String get value {
    switch (this) {
      case OperationalExpenseCategory.permits: return 'permits';
      case OperationalExpenseCategory.incentives: return 'incentives';
      case OperationalExpenseCategory.communications: return 'communications';
      case OperationalExpenseCategory.training: return 'training';
      case OperationalExpenseCategory.generalTransport: return 'general_transport';
      case OperationalExpenseCategory.equipment: return 'equipment';
      case OperationalExpenseCategory.printing: return 'printing';
      case OperationalExpenseCategory.meetings: return 'meetings';
      case OperationalExpenseCategory.other: return 'other';
    }
  }
  ...
  String get labelEn {
    switch (this) {
      ...
      case OperationalExpenseCategory.communications: return 'Communications';
      case OperationalExpenseCategory.training: return 'Training';
      case OperationalExpenseCategory.generalTransport: return 'General Transportation';
      case OperationalExpenseCategory.equipment: return 'Equipment & Supplies';
      case OperationalExpenseCategory.printing: return 'Printing & Materials';
      case OperationalExpenseCategory.meetings: return 'Meetings & Events';
      case OperationalExpenseCategory.other: return 'Other';
    }
  }
  ...
  String get labelAr {
    switch (this) {
      case OperationalExpenseCategory.permits: return 'التصاريح';
      case OperationalExpenseCategory.incentives: return 'الحوافز';
      case OperationalExpenseCategory.communications: return 'الاتصالات';
      case OperationalExpenseCategory.training: return 'التدريب';
      case OperationalExpenseCategory.generalTransport: return 'النقل العام';
      case OperationalExpenseCategory.equipment: return 'المعدات واللوازم';
      case OperationalExpenseCategory.printing: return 'الطباعة والمواد';
      case OperationalExpenseCategory.meetings: return 'الاجتماعات والفعاليات';
      case OperationalExpenseCategory.other: return 'أخرى';
    }
  }
  
  static OperationalExpenseCategory fromString(String? value) {
    switch (value) {
      case 'permits': return OperationalExpenseCategory.permits;
      case 'incentives': return OperationalExpenseCategory.incentives;
      case 'communications': return OperationalExpenseCategory.communications;
      case 'training': return OperationalExpenseCategory.training;
      case 'general_transport': return OperationalExpenseCategory.generalTransport;
      case 'equipment': return OperationalExpenseCategory.equipment;
      case 'printing': return OperationalExpenseCategory.printing;
      case 'meetings': return OperationalExpenseCategory.meetings;
      case 'other': return OperationalExpenseCategory.other;
      default: return OperationalExpenseCategory.other;
    }
  }
  
  static List<OperationalExpenseCategory> get allCategories => OperationalExpenseCategory.values;
}
...
class OperationalCostSubmission {
  ...
  factory OperationalCostSubmission.fromJson(Map<String, dynamic> json) {
    ...
    return OperationalCostSubmission(
      id: json['id'] ?? '',
      expenseCategory: OperationalExpenseCategoryExtension.fromString(json['expense_category']),
      hubId: json['hub_id'],
  ...
  String get formattedAmount => '${amountInCurrency.toStringAsFixed(2)} $currency';
}
...
class CostSubmissionStats {
  ...
  factory CostSubmissionStats.fromSubmissions(List<OperationalCostSubmission> submissions) {
