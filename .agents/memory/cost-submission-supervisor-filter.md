...
7. Detect the special Kassala assignment with `is_kassala_hub_supervisor`; its resolver must include profile role/hubs, `additional_roles[].hub_id`, legacy roles, canonical roles, and the location secondary-hub fallback.
