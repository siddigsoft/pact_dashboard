...
7. Detect the special Kassala assignment with the authoritative `is_kassala_hub_supervisor` RPC; primary-role and cached action checks can miss secondary Supervisor assignments and wrongly render My Submissions/view-only/no-payment UI.
