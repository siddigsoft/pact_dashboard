...
**Current sprint:** Phase 1 · Sprint 1.2 (signed off PASS, awaiting pactdb apply)
**Next up:** Phase 1 · Sprint 1.3 — posting-engine unit-test suite + synthetic data generator
**Prerequisite for next apply:** Sprint 1.1 has been clean in pactdb for ≥ 24 h
...
| 1 | Accounting foundation (GL, posting engine, sanctions, SoD foundation, audit) | 🟡 IN PROGRESS — Sprint 1.1 + 1.2 SIGNED OFF, awaiting apply | 65% |
...
| 1.3 | Posting-engine unit-test suite + synthetic data generator | ⚪ QUEUED — next sprint | — | — | Migration filename reserved: `supabase/migrations/20260515_acct_phase1_sprint1_3.sql` |
| 1.F | Phase 1 frontend: `/accounting/coa`, `/accounting/journals`, `/accounting/trial-balance`, `/finance/audit-trail` + Arabic jsPDF font | ⚪ QUEUED — starts after 1.3 | — | — | — |
...
| 6 | Idempotency on posting (race-safe) | 🟢 | Sprint 1.1 (ON CONFLICT on `idempotency_key`) |
| 7 | Period close prevents posting to closed periods | 🟢 | Sprint 1.1 (PERIOD_CLOSED + posting-date guard) |
...
**Phase 1 goes "done" when:** all 10 are 🟢 — currently 7 / 10 fully green,
2 / 10 partial (4, 10), 1 / 10 frontend-pending (9).
...
| Sprint 1.3 build | ⚪ Queued | Agent | Posting-engine unit-test suite + synthetic data generator |
