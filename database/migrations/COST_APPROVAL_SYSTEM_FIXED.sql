-- =========================================
-- SITE VISIT COST APPROVAL SYSTEM MIGRATION (FIXED)
-- =========================================
-- Fixed to work with existing site_visits table structure
...
-- Cost Submissions: Finance/Admin view all
...
-- Cost Submissions: Update own pending
...
-- Cost Submissions: Finance can update for approval
...
-- Cost Submissions: Admin can delete
...
-- Cost History: View if can view submission
