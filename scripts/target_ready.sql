...
CREATE TABLE public.classification_fee_structures (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE public.cost_adjustment_audit (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE public.cost_approval_history (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  submission_id uuid,
...
CREATE TABLE public.deletion_audit_log (
  ...
  CONSTRAINT deletion_audit_log_deleted_by_fkey FOREIGN KEY (deleted_by) REFERENCES public.profiles(id),
  CONSTRAINT deletion_audit_log_restored_by_fkey FOREIGN KEY (restored_by) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.digital_signatures (
  ...
  CONSTRAINT digital_signatures_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.down_payment_requests (
  ...
  CONSTRAINT down_payment_requests_requested_by_fkey FOREIGN KEY (requested_by) REFERENCES public.profiles(id),
  CONSTRAINT down_payment_requests_supervisor_id_fkey FOREIGN KEY (supervisor_id) REFERENCES public.profiles(id),
  CONSTRAINT down_payment_requests_supervisor_approved_by_fkey FOREIGN KEY (supervisor_approved_by) REFERENCES public.profiles(id),
  CONSTRAINT down_payment_requests_admin_processed_by_fkey FOREIGN KEY (admin_processed_by) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.handwriting_signatures (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  user_id uuid NOT NULL,
  ...
  CONSTRAINT handwriting_signatures_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);

CREATE TABLE public.historical_site_costs (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE public.hub_states (
  ...
  CONSTRAINT hub_states_hub_id_fkey FOREIGN KEY (hub_id) REFERENCES public.hubs(id)
);
...
CREATE TABLE public.mmp_budgets (
  ...
  CONSTRAINT mmp_budgets_parent_budget_id_fkey FOREIGN KEY (parent_budget_id) REFERENCES public.mmp_budgets(id),
  CONSTRAINT mmp_budgets_allocated_by_fkey FOREIGN KEY (allocated_by) REFERENCES public.profiles(id),
  CONSTRAINT mmp_budgets_mmp_file_id_fkey FOREIGN KEY (mmp_file_id) REFERENCES public.mmp_files(id),
  CONSTRAINT mmp_budgets_project_budget_id_fkey FOREIGN KEY (project_budget_id) REFERENCES public.project_budgets(id)
);
...
CREATE TABLE public.mmp_site_entries (
  ...
  CONSTRAINT mmp_site_entries_claimed_by_fkey FOREIGN KEY (claimed_by) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_visit_started_by_fkey FOREIGN KEY (visit_started_by) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_visit_completed_by_fkey FOREIGN KEY (visit_completed_by) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_registry_site_id_fkey FOREIGN KEY (registry_site_id) REFERENCES public.sites_registry(id),
  CONSTRAINT mmp_site_entries_rejected_by_fkey FOREIGN KEY (rejected_by) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_mmp_file_id_fkey FOREIGN KEY (mmp_file_id) REFERENCES public.mmp_files(id),
  CONSTRAINT mmp_site_entries_verified_by_user_id_fkey FOREIGN KEY (verified_by_user_id) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_completed_by_user_id_fkey FOREIGN KEY (completed_by_user_id) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_forwarded_by_user_id_fkey FOREIGN KEY (forwarded_by_user_id) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_forwarded_to_user_id_fkey FOREIGN KEY (forwarded_to_user_id) REFERENCES public.profiles(id),
  CONSTRAINT mmp_site_entries_cost_acknowledged_by_fkey FOREIGN KEY (cost_acknowledged_by) REFERENCES public.profiles(id)
);
