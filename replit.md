...
*   **Chart of Accounts Management (`/accounting/coa`):** Full Add / Edit / Delete for admin and super_admin roles with country filtering.
...
*   **Journal Entry Creation (`/accounting/journals`):** Multi-line entry dialog with period selector, posting date, bilingual description, dynamic line table, and live balance indicator.
