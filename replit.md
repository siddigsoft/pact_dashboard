...
*   **Targeted Email Notification System (Optimized Dec 2024):**
    ...
    - MMP Forward to FOM: Email sent to selected FOM(s) only, CC: Hub Supervisors + 1 Super Admin
    - MMP Forward to Coordinators: Email sent to selected coordinators only, CC: Hub Supervisors + 1 Super Admin
    - Site Verified by Coordinator: Email sent to FOM only, CC: Hub Supervisors + 1 Super Admin
    - 2-second delay between emails when sending to multiple recipients
    - Hub Supervisors included for accountability on all MMP and site workflow emails
