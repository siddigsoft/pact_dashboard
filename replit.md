...
*   **Unified Communications Screen:** Mobile Communications screen (`lib/screens/communications_screen.dart`) consolidating calls and messages into a single interface for streamlined team communication.
