...
*   **Cross-Platform Feature Parity (Web ↔ Mobile):** Both platforms now reflect identical feature sets. Web added: Safety Hub (SOS alerts, emergency contacts, safety checklist), Incident Reports (CRUD with severity/status tracking), Equipment Tracking (inventory management), Comprehensive Monitoring Form (3-step AM/DM/PDM form), and Helpline (emergency contacts management) — all added to sidebar under Field Operations and Help & Support. Mobile added full navigation expansion (5-tab bottom nav + "More" grid with 30 shortcuts), plus new screens: Projects, Budget, Exchange Rates, Staff Directory, Transaction Scanner (AI OCR), Reconciliation Dashboard, Hub Management, Coordinator Dashboard, Monitoring Plan, Archive, Retainer Management, Data Export, Global Search, and MMP Management. Chat, Reports, and Site Verification screens re-enabled in mobile navigation.
