-- Safe wallet test data - uses only site_visit_fee and adjustment types
-- These are guaranteed to work based on your database constraints
...
BEGIN
  ...
  -- Create transactions using ONLY site_visit_fee and adjustment (guaranteed to work)
  IF v1_id IS NOT NULL THEN
    ...
    VALUES
      -- Wallet 1 (Level A)
      (w1_id, u1_id, 'adjustment', 750, 'SDG', NULL, 'Monthly retainer - November 2025', 0, 750, '2025-11-01 09:00:00'),
      (w1_id, u1_id, 'site_visit_fee', 500, 'SDG', v1_id, 'Site visit - Hospital Monitoring', 750, 1250, '2025-11-15 14:30:00'),
      (w1_id, u1_id, 'adjustment', 250, 'SDG', NULL, 'Performance bonus', 1250, 1500, '2025-11-16 10:00:00'),
      
      -- Wallet 2 (Level B)
      (w2_id, u2_id, 'adjustment', 437.5, 'SDG', NULL, 'Monthly retainer - November 2025', 0, 437.5, '2025-11-01 09:00:00'),
      (w2_id, u2_id, 'site_visit_fee', 437.5, 'SDG', v2_id, 'Site visit - School Assessment', 437.5, 875, '2025-11-18 11:15:00'),
      
      -- Wallet 3 (Level C)
      (w3_id, u3_id, 'adjustment', 312.5, 'SDG', NULL, 'Monthly retainer - November 2025', 0, 312.5, '2025-11-01 09:00:00'),
