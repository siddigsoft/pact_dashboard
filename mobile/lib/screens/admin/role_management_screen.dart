...
class _RoleManagementScreenState extends State<RoleManagementScreen> {
  ...
  final List<Map<String, dynamic>> _defaultRoles = [
    ...
    },
    {
      ...
      'name_ar': 'موظف',
      'description_en':
          'Office staff — tasks, calendar, communications, and payslips',
      'description_ar':
          'موظفو المكتب — المهام والتقويم والتواصل وكشوف الرواتب',
      'color': const Color(0xFF1D3461),
      'icon': Icons.badge_outlined,
      'permissions': ['tasks.own', 'calendar.read', 'wallet.own'],
    },
    {
      'name': 'finance',
      'name_en': 'Finance',
