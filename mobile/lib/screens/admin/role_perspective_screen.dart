...
class _RolePerspectiveScreenState extends State<RolePerspectiveScreen> {
  ...
  static const _permMatrix = {
    'employee': {
      ...
      'can_see_all_hubs': false,
      'can_see_reports': false,
      'description':
          'HQ / office employee. Tasks, leave, payslips — no field site visits.',
    },
    'coordinator': {
      'screens': [
        'Dashboard',
      ...
      'can_see_reports': false,
      'description':
          'Field data collector. Sees assigned sites and own financial records.',
    },
    'supervisor': {
      'screens': [
        'Dashboard',
      ...
      'description':
          'Oversees a group of coordinators. Can approve cost submissions for own team.',
    },
    'hubSupervisor': {
      'screens': [
        'Dashboard',
      ...
      'can_see_reports': true,
      'description':
          'Manages a hub. Sees all coordinators and supervisors in their hub.',
    },
    'fom': {
      'screens': [
        'Dashboard',
      ...
      'can_manage_users': false,
      'can_see_finance': true,
      'can_see_all_hubs': true,
      'can_see_reports': true,
      'description':
          'Field Operation Manager. Cross-hub visibility. Can approve and broadcast.',
    },
    'admin': {
      'screens': [
        'Dashboard',
      ...
      'can_see_reports': true,
      'description':
          'Platform administrator. Full access except a few super-admin-only tools.',
    },
    'super_admin': {
      'screens': [
        'ALL screens',
      ...
      'can_see_reports': true,
      'description':
          'Full platform access. Manages all users, permissions, and configurations.',
    },
  };
  ...
  Future<void> _loadSampleUser(String role) async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _sampleUser = data != null ? Map<String, dynamic>.from(data) : null;
          _loadingUser = false;
        });
      }
    } catch (_) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Role selector
            Text(
              'Select a role to preview its perspective:',
            ...
            if (_selectedRole != null && perms != null) ...[
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          (_sampleUser!['full_name'] as String? ?? '?')
                              .trim()
                              .split(' ')
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Example: ${_sampleUser!['full_name'] ?? ''}',
                              style: GoogleFonts.poppins(
                                fontWeight: FontWeight.w700,
                                fontSize: 13,
                              ),
                            ),
                            if ((_sampleUser!['hub_name'] as String?)
                                    ?.isNotEmpty ==
                                true)
                              Text(
                                _sampleUser!['hub_name'] as String,
                                style: GoogleFonts.poppins(
                                  fontSize: 11,
              ...
              _capSection('Capabilities', [
                ...
                _capRow(
                  'Sees Financial Data',
                  perms['can_see_finance'] as bool,
                ),
                _capRow(
                  'Cross-Hub Visibility',
                  perms['can_see_all_hubs'] as bool,
                ),
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'Select a role above to preview what that user sees',
                      style: GoogleFonts.poppins(
      ...
      child: Row(
        children: [
          Icon(
            ...
            size: 18,
            color: enabled ? const Color(0xFF16A34A) : Colors.grey[400],
          ),
  ...
  Widget _screensList(List<String> screens, Color color) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Accessible Screens (${screens.length})',
            style: GoogleFonts.poppins(
              fontWeight: FontWeight.w700,
              fontSize: 13,
              color: const Color(0xFF0F2041),
