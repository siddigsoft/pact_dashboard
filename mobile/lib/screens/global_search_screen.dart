    ...
    try {
      await Future.wait([
        _supabase
            ...
            .select('id, mmp_code, status')
            .ilike('mmp_code', '%$query%')
            .limit(5)
            .then((data) {
              for (final r in data) {
                results.add(
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'MMPs, site visits, staff, documents, incidents',
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      backgroundColor: _typeColor(r.type).withOpacity(0.12),
                      child: Icon(r.icon, color: _typeColor(r.type), size: 20),
                    ),
                    title: Text(
                      r.title,
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _typeColor(r.type).withOpacity(0.12),
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Text(
                            r.type,
