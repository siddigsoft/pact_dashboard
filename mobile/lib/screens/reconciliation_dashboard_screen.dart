        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: _isLoading
          ? const ShimmerBody(
              layout: ShimmerLayout.reconciliation,
              hasStats: true,
              listItems: 5,
            )
          : RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: ['all', 'matched', 'pending', 'discrepancy']
                          .map(
                            (s) => Padding(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              _items.isEmpty
                                  ? 'Reconciliation is managed on the web platform.'
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '\$${(item['expected_amount'] ?? 0).toString()}',
                                          style: const TextStyle(
                                            fontWeight: FontWeight.w600,
                                          ),
                                        ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '\$${((item['actual_amount'] ?? 0) - (item['expected_amount'] ?? 0)).toString()}',
                                          style: TextStyle(
                                            fontWeight: FontWeight.w600,
