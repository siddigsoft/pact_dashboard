...
class CompleteVisitFlow {
  ...
  static Future<CompleteVisitResult?> run(
    ...
    try {
      ...
      // Completion/submission is never a wallet earning event. The trusted
      // WFP-confirmation server transition owns ordinary fee crediting.
      debugPrint(
        '[CompleteVisitFlow] Completion saved; wallet credit deferred until WFP confirmation',
      );
