...
class _ProfessionalMovableToggleState
  ...
  void _hideToggle() {
    ...
    _savePreferences();
    // No snackbar here — the corner indicator dot is the restore affordance.
    // A lingering snackbar blocked the bottom nav and stayed open after tapping
    // the indicator because nothing dismissed it.
  }
