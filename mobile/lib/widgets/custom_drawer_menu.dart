...
import '../screens/team_tasks_screen.dart';
...
class _CustomDrawerMenuState extends ConsumerState<CustomDrawerMenu> {
  ...
  bool get _isPureSupervisor => _isSupervisor && !_isCoordinator;

  /// Matches [MainLayout] supervisor bottom bar (not coordinator / employee).
  bool get _usesSupervisorShell =>
      !_isEmployee &&
      UserRoleHelper.isSupervisor(_role) &&
      !UserRoleHelper.isCoordinator(_role);

  int get _tasksTabIndex => _isEmployee ? 1 : 3;

  int get _communicationsTabIndex => _isEmployee ? 2 : 4;

  int get _walletTabIndex => _isEmployee ? 3 : 5;
  ...
  void _openDrawerRoute(
    ...
    if (_usesSupervisorShell && supervisorTab != null) {
      _openInMainLayout(screen, currentIndex: supervisorTab);
      return;
    }
    if (_isEmployee && employeeTab != null) {
      _openInMainLayout(screen, currentIndex: employeeTab);
      return;
    }
    if (!_isEmployee && !_usesSupervisorShell && fieldTab != null) {
      _openInMainLayout(screen, currentIndex: fieldTab);
      return;
    }
    Navigator.of(context).push(MaterialPageRoute(builder: (_) => screen));
  }
                    ...
                    items: [
                      ...
                      if (!_isEmployee &&
                        ...
                        _MenuItemData(
                          ...
                          onTap: () {
                            if (_usesSupervisorShell) {
                              _pushScreen(const SiteVerificationScreen());
                            } else {
                              _openDrawerRoute(
                      ...
                      if (!UserRoleHelper.isDataCollector(_role))
                        _MenuItemData(
                          icon: Icons.calendar_month_rounded,
                          title: 'Calendar',
                          subtitle: 'Schedule and planning',
                          iconColor: Colors.purple,
                          onTap: () => _pushScreen(const CalendarScreen()),
                        ),
                      _MenuItemData(
                        ...
                        onTap: () => _pushScreen(const DocumentsScreen()),
                      ),
                        ...
                        onTap: () {
                          if (_usesSupervisorShell) {
                            ...
                            _openDrawerRoute(
                              const ChatsScreen(),
                              employeeTab: 2,
                              fieldTab: _communicationsTabIndex,
                            );
                          }
                        },
                      ),
                      _MenuItemData(
                        ...
                        title: 'My Tasks',
                        subtitle: 'Personal and assigned work items',
                        iconColor: const Color(0xFF1D3461),
                        onTap: () {
                          _openDrawerRoute(
                            const MyTasksScreen(),
                            employeeTab: 1,
                      ...
                      if (UserRoleHelper.canSeeTeamMonitor(_role))
                        _MenuItemData(
                          icon: Icons.groups_outlined,
                          title: 'Team Monitor',
                          subtitle: 'Workload across your team',
                          iconColor: const Color(0xFF1D3461),
                          onTap: () {
                      ...
                      _MenuItemData(
                        ...
                        iconColor: Colors.purple,
                        onTap: () => _pushScreen(const HelpSupportScreen()),
                      ),
                      _MenuItemData(
                      ...
                      _MenuItemData(
                        ...
                        onTap: () {
                          if (_usesSupervisorShell) {
                            _pushScreen(const CommunicationsScreen());
                          } else {
                            _openDrawerRoute(
                      ...
                      if (_showAllForAdmin ||
                        ...
                        _MenuItemData(
                          ...
                          onTap: () =>
                              _pushScreen(const DigitalSignaturesScreen()),
                        ),
