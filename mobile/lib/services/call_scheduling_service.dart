...
class CallSchedulingService {
  ...
  Future<void> _notifyParticipant(ScheduledCall call) async {
    try {
      ...
      await NotificationInsertService.insertNotification({
        'recipient_id': call.participantId,
        'user_id': call.participantId,
        'type': 'scheduled_call',
        'event_type': 'scheduled_call',
        'title_en': call.isVideoCall ? 'Video Call Invitation' : 'Call Invitation',
        'message_en':
  ...
  Future<bool> transferCall({
    ...
    try {
      ...
      await NotificationInsertService.insertNotification({
        ...
        'title_en': 'Call Transfer',
        'message_en': 'You have been transferred a call',
        'title': 'Call Transfer',
  ...
  Future<bool> leaveVoicemail({
    ...
    try {
      ...
      // Notify recipient
      await NotificationInsertService.insertNotification({
        'recipient_id': forUserId,
        'user_id': forUserId,
        'type': 'voicemail',
        'event_type': 'voicemail',
        'title_en': 'New Voicemail',
        'message_en': 'You have a new voicemail message',
        'title': 'New Voicemail',
