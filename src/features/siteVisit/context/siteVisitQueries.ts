 ...
 * Fetch logic lives in siteVisitRepository — this file owns only the hooks and cache keys.
 */
import { useQuery, useQueryClient } from '@tanstack/react-query';
import { fetchSiteVisits } from '@/features/siteVisit/repository/siteVisitRepository';
