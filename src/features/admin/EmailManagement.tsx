...
import { fetchProfilesForEmailCompose, invokeSendEmail } from '@/features/admin/repository/emailManagementRepository';
...
export default function EmailManagement() {
  ...
  const checkSmtpStatus = async () => {
    ...
    try {
      ...
      const { data, error } = await invokeSendEmail({ action: 'check-config' });
  ...
  const fetchUsers = async () => {
    ...
    try {
      const { data, error } = await fetchProfilesForEmailCompose();
