...
const DashboardCalendar = React.lazy(() => 
  import('@/features/dashboard/components/DashboardCalendar')
...
const ActivityFeed = React.lazy(() => import('@/features/dashboard/components/ActivityFeed'));
const DashboardLocationSharingCard = React.lazy(() => import('@/features/location/components/DashboardLocationSharingCard'));
const LiveTeamMapWidget = React.lazy(() => import('@/features/dashboard/components/LiveTeamMapWidget'));
