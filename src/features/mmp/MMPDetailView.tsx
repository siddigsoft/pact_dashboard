...
import { fetchMmpSiteEntriesRowsByMmpFileId } from '@/features/siteVisit/repository/siteVisitRepository';
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@/components/ui/alert-dialog";
import { Textarea } from "@/components/ui/textarea";
import AuditLogViewer from "@/features/audit/components/AuditLogViewer";
import ComplianceTracker from "@/features/audit/components/ComplianceTracker";
import { MMPStageIndicator } from "@/features/mmp/components/MMPStageIndicator";
import MMPVersionHistory from "@/features/mmp/components/MMPVersionHistory";
import { MMPInfoCard } from "@/features/siteVisit/components/MMPInfoCard";
import MMPSiteInformation from "@/features/mmp/components/MMPSiteInformation";
import { MMPStatusBadge } from "@/features/mmp/components/MMPStatusBadge";

// New components
import MMPOverviewCard from "@/features/mmp/components/MMPOverviewCard";
import MMPSiteEntriesTable from "@/features/mmp/components/MMPSiteEntriesTable";
import MMPFileManagement from "@/features/mmp/components/MMPFileManagement";
import RecallHistory from "@/features/mmp/components/RecallHistory";
import { useAuthorization } from "@/features/auth/hooks/use-authorization";
import ForwardToFOMDialog from "@/features/mmp/components/ForwardToFOMDialog";
import { ReclaimFromCoordinatorDialog } from "@/features/mmp/components/ReclaimFromCoordinatorDialog";
import ForwardToCoordinatorsDialog from "@/components/mmp/ForwardToCoordinatorsDialog";
import CoordinatorSummaryCard from "@/features/mmp/components/CoordinatorSummaryCard";
...
const MMPDetailView = () => {
  ...
  useEffect(() => {
    const loadSiteEntries = async () => {
      ...
      const { data, error } = await fetchMmpSiteEntriesRowsByMmpFileId(id);
      if (error) {
