...
import { MMPComprehensiveVerificationComponent } from '@/features/mmp/components/MMPComprehensiveVerification';
...
const MMPVerificationPage: React.FC = () => {
  ...
  const hasVerificationAccess = isAdmin || isFOM || isCoordinator || isSupervisor || checkPermission('mmp', 'approve');
