...
import MMPPartialUpdate from '@/features/mmp/components/MMPPartialUpdate';
import MMPFileUpload from '@/features/mmp/components/MMPFileUpload';
import { ActivityManager } from '@/features/project/components/activity/ActivityManager';
import { useToast } from '@/shared/hooks/use-toast';
import FieldTeamMapPermissions from '@/features/location/components/FieldTeamMapPermissions';
import { insertMmpSiteEntryRows, updateMmpSiteEntryFields } from '@/features/mmp/repository/mmpRepository';
  ...
  const handleUpdateSites = async (sites: any[]): Promise<boolean> => {
    ...
    try {
      ...
      for (const site of sites) {
        ...
        if (site.id) {
          await updateMmpSiteEntryFields(site.id, updateData);
        } else {
          await insertMmpSiteEntryRows([{ ...updateData, mmp_file_id: id }]);
        }
      }
