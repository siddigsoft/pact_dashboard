...
const SignatureManager = lazy(() =>
  import('@/features/documents/components/signature/SignatureManager').then((module) => ({
    ...
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your signatures and view signing history</p>
        </div>
