...
import {
  ...
  skipVersion,
  formatReleaseNotes,
} from '@/platform/web/app-update';
import { hapticFeedback } from '@/platform/mobile/enhanced-haptics';
...
export function useAppUpdateCheck() {
  ...
  useEffect(() => {
    ...
    const setup = async () => {
      const { registerForAutoUpdateCheck, initAppVersion } = await import('@/platform/web/app-update');
