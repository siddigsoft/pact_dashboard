...
import { useSettingsSafe } from '@/features/settings/context/SettingsContext';
import { useBiometric } from '@/features/auth/hooks/use-biometric';
import { useToast } from '@/shared/hooks/use-toast';
import { useMobilePermissions } from '@/platform/mobile/hooks/use-mobile-permissions';
import { useMobileExtendedSettings, FontSize, HapticIntensity, ImageQuality } from '@/platform/mobile/hooks/use-mobile-extended-settings';
