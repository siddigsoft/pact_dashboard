...
export function exportToExcel(requests: DownPaymentRequest[], filename: string = 'down-payments'): void {
  const data = requests.map(req => ({
    ...
    'Activity Type': req.activityType || '',
    ...
    'Approved Amount (SDG)': req.approvedAmount || req.requestedAmount,
    ...
    'Supervisor Status': req.supervisorStatus || '',
    'Supervisor Approved By': req.supervisorApprovedByName || req.supervisorApprovedBy || '',
    'Supervisor Approved At': req.supervisorApprovedAt ? format(new Date(req.supervisorApprovedAt), 'yyyy-MM-dd HH:mm') : '',
    'Admin Status': req.adminStatus || '',
    'Admin Processed By': req.adminProcessedByName || req.adminProcessedBy || '',
    'Admin Processed At': req.adminProcessedAt ? format(new Date(req.adminProcessedAt), 'yyyy-MM-dd HH:mm') : '',
