...
export const roleTemplates: RoleTemplate[] = [
  ...
  },
  {
    ...
    description: 'Analytics and reporting focus. Can view all operational data including projects, MMPs, site visits, and finances. Creates reports and exports for analysis purposes.',
    category: 'administrative',
    icon: 'BarChart3',
    recommended: true,
    permissions: [
  ...
  {
    id: 'state_coordinator',
    name: 'State Coordinator',
    displayName: 'State Coordinator',
    description: 'Coordinates field activities across a specific state. Manages site visits, assigns work to data collectors, monitors progress, and ensures state-level operational compliance.',
    category: 'field',
    icon: 'Globe',
    recommended: false,
    permissions: [
  ...
  },
  {
    ...
    description: 'Read-only access to all financial data for audit purposes. Can view wallets, budgets, cost submissions, advances, reports, and audit logs but cannot approve, modify, or delete any data.',
    category: 'financial',
    icon: 'Eye',
    recommended: true,
    permissions: [
