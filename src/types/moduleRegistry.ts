    ...
    pages: [
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'mmp:export', label: 'Export MMP Data', description: 'Download MMP data and operational reports', resource: 'mmp', action: 'export' },
  ...
  // ─── Finance ──────────────────────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { page: 'Cost Approval', route: '/cost-approval', description: 'Review submitted costs', actions: [
        ...
        { key: 'cost_submissions:create', label: 'Create Cost Submission', description: 'Submit a new cost request', resource: 'cost_submissions', action: 'create' },
        { key: 'cost_submissions:update', label: 'Edit Cost Submission', description: 'Update an eligible cost request', resource: 'cost_submissions', action: 'update' },
        ...
        { key: 'cost_submissions:mark_paid', label: 'Mark Costs Paid', description: 'Record payment for an approved cost request', resource: 'cost_submissions', action: 'mark_paid' },
        { key: 'cost_submissions:send_to_finance', label: 'Send Costs to Finance', description: 'Request payment processing from Finance', resource: 'cost_submissions', action: 'send_to_finance' },
        { key: 'cost_submissions:recall', label: 'Recall Cost Submission', description: 'Recall a submission from review before payment', resource: 'cost_submissions', action: 'recall' },
        { key: 'cost_submissions:revert_paid', label: 'Revert Paid Cost', description: 'Return a paid cost request to approved status', resource: 'cost_submissions', action: 'revert_paid' },
        { key: 'cost_submissions:revert_tier', label: 'Revert Approval Tier', description: 'Step an approval workflow back one tier', resource: 'cost_submissions', action: 'revert_tier' },
        { key: 'cost_submissions:reconcile', label: 'Reconcile Costs', description: 'Reconcile payment and receipt information', resource: 'cost_submissions', action: 'reconcile' },
        { key: 'cost_submissions:export', label: 'Export Cost Submissions', description: 'Download cost submission data', resource: 'cost_submissions', action: 'export' },
      ] },
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'cost_submissions:mark_paid', label: 'Mark Cost Submission Paid', description: 'Open the payment workflow for an approved submission', resource: 'cost_submissions', action: 'mark_paid' },
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'fixed_assets:assign', label: 'Assign Asset', description: 'Assign an asset to a staff member', resource: 'fixed_assets', action: 'assign', isAdminOnly: true },
          { key: 'fixed_assets:archive', label: 'Return / Retire Asset', description: 'Return, retire, or archive an asset', resource: 'fixed_assets', action: 'archive', isAdminOnly: true },
  ...
  // ─── HR & People ──────────────────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      },
      {
        ...
        actions: [
          { key: 'salary_advances:create', label: 'Issue Salary Advance', description: 'Grant an advance to staff', resource: 'salary_advances', action: 'create', isAdminOnly: true },
          { key: 'salary_advances:update', label: 'Update Recovery Schedule', description: 'Adjust advance recovery plan', resource: 'salary_advances', action: 'update', isAdminOnly: true },
        ],
      },
      {
        page: 'Leave Requests',
      ...
      },
      {
        ...
        actions: [
          ...
          { key: 'hr_analytics:delete', label: 'Delete Review',            description: 'Remove an eligible appraisal record',     resource: 'hr_analytics', action: 'delete', isDestructive: true, isAdminOnly: true },
      ...
      },
      {
        page: 'Recruitment',
        route: '/recruitment',
        description: 'Job postings, requisitions, candidates, interviews, scorecards, and offers',
        actions: [
          { key: 'hr:read', label: 'View Recruitment', description: 'Browse recruitment records and candidates', resource: 'hr', action: 'read' },
          { key: 'hr:create', label: 'Create Job / Candidate', description: 'Create a job posting, requisition, or candidate record', resource: 'hr', action: 'create' },
          { key: 'hr:update', label: 'Edit Recruitment Records', description: 'Edit postings, candidates, interviews, scorecards, or offers', resource: 'hr', action: 'update' },
          { key: 'hr:delete', label: 'Delete Recruitment Record', description: 'Delete an eligible recruitment record', resource: 'hr', action: 'delete', isDestructive: true },
          { key: 'hr:submit', label: 'Submit Requisition / Scorecard', description: 'Submit a requisition or candidate assessment', resource: 'hr', action: 'submit' },
          { key: 'hr:approve', label: 'Approve Requisition / Offer', description: 'Approve a recruitment request or offer', resource: 'hr', action: 'approve' },
          { key: 'hr:send', label: 'Send Candidate Offer', description: 'Send an approved candidate offer', resource: 'hr', action: 'send' },
          { key: 'hr:export', label: 'Export Recruitment Data', description: 'Download recruitment reports', resource: 'hr', action: 'export' },
        ],
      },
      {
    ...
    pages: [
      {
        ...
        actions: [
          ...
          { key: 'surveys:status', label: 'Change Survey Status', description: 'Open or close survey response collection', resource: 'surveys', action: 'status' },
