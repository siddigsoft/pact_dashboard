...
export const PROJECT_TYPE_CONFIGS: Record<string, ProjectTypeConfig> = {
  ...
  assessment: {
    ...
    deliverables: [
      ...
      { id: 'as-16', label: 'Budget Approval Memo', phase: 'Finance & Fund Approvals' },
      { id: 'as-17', label: 'Fund Release Authorisation Letter', phase: 'Finance & Fund Approvals' },
      { id: 'as-18', label: 'Finance Sign-Off Document', phase: 'Finance & Fund Approvals' },
