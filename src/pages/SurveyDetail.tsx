                  ...
                  <div className="border-t border-slate-100 pt-3 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div className="border border-amber-200 rounded-lg p-3 space-y-2 bg-amber-50">
                        <div>
                          <p className="text-[11px] font-semibold text-amber-700">Send test</p>
                          <p className="text-[10px] text-amber-600 mt-0.5">Adds a [TEST] label. Use to verify delivery without confusing recipients.</p>
                        </div>
                        <button
                          type="button"
                          data-testid="btn-test-reminder"
                          onClick={sendTestReminder}
                          disabled={testingReminder || sendingReminder}
                          className={cn(
                      ...
                      <div className="border border-indigo-200 rounded-lg p-3 space-y-2 bg-indigo-50">
                        <div>
                          <p className="text-[11px] font-semibold text-indigo-700">Send reminder now</p>
                          <p className="text-[10px] text-indigo-600 mt-0.5">Sends the real reminder immediately — no label. Use any time you need.</p>
                        </div>
                        <button
                          type="button"
                          data-testid="btn-send-reminder"
                          onClick={sendRealReminder}
                          disabled={sendingReminder || testingReminder}
                          className={cn(
                            'w-full flex items-center justify-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg border transition-colors',
                            sendingReminder
