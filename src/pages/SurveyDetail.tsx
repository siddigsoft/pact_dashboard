              ...
              {settingsForm.reminder_enabled && (
                <div className="space-y-4 pt-1 border-t border-slate-100">
                  ...
                  <div className="border-t border-slate-100 pt-3 space-y-2">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs font-semibold text-slate-700">Test reminders now</p>
                        <p className="text-[11px] text-slate-400 mt-0.5">Sends the actual messages immediately — bypasses the schedule. Recipients will see a [TEST] label.</p>
                      </div>
                      <button
                        type="button"
                        ...
                        className={cn(
                          'flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg border transition-colors shrink-0 ml-4',
                          testingReminder
                    ...
                    {testReminderResult && (
                      <div className="bg-green-50 border border-green-200 rounded-lg px-3 py-2.5 space-y-2">
                        <p className="text-[11px] font-semibold text-green-700 flex items-center gap-1.5">
                          <CheckCircle2 className="w-3.5 h-3.5" />Test sent successfully
                        </p>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="bg-white border border-green-100 rounded-lg px-2.5 py-1.5 text-center">
                            <p className="text-lg font-bold text-green-700">{testReminderResult.wa_sent}<span className="text-xs text-green-400">/{testReminderResult.wa_total}</span></p>
                            <p className="text-[10px] text-slate-500 flex items-center justify-center gap-1"><MessageSquareMore className="w-3 h-3" />WhatsApp sent</p>
                          </div>
                          <div className="bg-white border border-green-100 rounded-lg px-2.5 py-1.5 text-center">
                            <p className="text-lg font-bold text-green-700">{testReminderResult.emails_sent}<span className="text-xs text-green-400">/{testReminderResult.emails_total}</span></p>
                            <p className="text-[10px] text-slate-500 flex items-center justify-center gap-1"><Mail className="w-3 h-3" />Emails sent</p>
                          </div>
                        </div>
                        {testReminderResult.phones.length > 0 && (
                          <div>
                            <p className="text-[10px] text-slate-500 mb-1">WhatsApp numbers reached:</p>
                            <div className="flex flex-wrap gap-1">
                        ...
                        {testReminderResult.emails.length > 0 && (
                          <div>
                            <p className="text-[10px] text-slate-500 mb-1">Email addresses reached:</p>
                            <div className="flex flex-wrap gap-1">
