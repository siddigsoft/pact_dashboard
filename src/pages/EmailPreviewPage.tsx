    ...
    <td style="padding:38px 36px 32px;">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0 0 18px 0;font-size:12.5px;border-radius:6px;overflow:hidden;border:1px solid #D1D5DB;">
        ...
        <tr style="background:#F8FAFC;">
          ...
          <td style="padding:5px 12px;color:#111827;border-bottom:1px solid #E5E7EB;font-size:12.5px;line-height:1.3;">Advance Request / طلب سلفة</td>
        </tr>
        <tr style="background:#FFFFFF;">
          ...
          <td style="padding:5px 12px;color:#111827;border-bottom:1px solid #E5E7EB;font-size:12.5px;line-height:1.3;">Transportation Advance (Bulk)</td>
        </tr>
        <tr style="background:#F8FAFC;">
        ...
        <tr style="background:#F8FAFC;">
          <td style="padding:5px 12px;font-weight:600;color:#4B5563;border-bottom:1px solid #E5E7EB;border-right:1px solid #E5E7EB;font-size:12.5px;line-height:1.3;">Approved By / تمت الموافقة من</td>
          <td style="padding:5px 12px;color:#111827;border-bottom:1px solid #E5E7EB;font-size:12.5px;line-height:1.3;">${d.approverName}</td>
        </tr>
        <tr style="background:#FFFFFF;">
          <td style="padding:5px 12px;font-weight:600;color:#4B5563;border-right:1px solid #E5E7EB;font-size:12.5px;line-height:1.3;">Attachment / المرفق</td>
          <td style="padding:5px 12px;color:#111827;font-size:12.5px;line-height:1.3;">Excel Report (4 sheets: Statement · Full Details · By State · By Enumerator)</td>
        </tr>
      </table>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0 24px 0;">
        <tr>
          <td style="padding:0 5px 0 0;width:50%;">
            <a href="#" style="display:block;padding:12px 16px;background:#0F2041;color:#FFFFFF;text-decoration:none;border-radius:6px;font-weight:700;font-size:13px;text-align:center;line-height:1.35;">
          ...
          <td style="padding:0 0 0 5px;width:50%;">
            <a href="#" style="display:block;padding:12px 16px;background:#1D3461;color:#FFFFFF;text-decoration:none;border-radius:6px;font-weight:700;font-size:13px;text-align:center;line-height:1.35;">
              Download Report
