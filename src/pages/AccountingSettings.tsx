...
const MODULE_TABLES: { table: string; label: string; icon: React.ElementType; link?: string }[] = [
  { table: 'chart_of_accounts',       label: 'Chart of Accounts',    icon: BarChart3,    link: '/accounting/coa' },
  { table: 'journal_entries',         label: 'Journal Entries',       icon: BookOpen,     link: '/accounting/journals' },
  { table: 'journal_entry_lines',     label: 'Journal Lines',         icon: Receipt,      link: '/accounting/journals' },
  { table: 'fiscal_years',            label: 'Fiscal Years',          icon: Clock,        link: '/accounting/fiscal-years' },
  { table: 'fiscal_periods',          label: 'Fiscal Periods',        icon: Clock,        link: '/accounting/fiscal-years' },
  { table: 'accounting_funds',        label: 'Funds',                 icon: Wallet,       link: '/accounting/funds' },
  { table: 'accounting_vendors',      label: 'Vendors',               icon: Landmark,     link: '/accounting/vendors' },
  { table: 'purchase_orders',         label: 'Purchase Orders',       icon: ShoppingCart, link: '/accounting/purchase-orders' },
  { table: 'purchase_requisitions',   label: 'Purchase Requisitions', icon: ClipboardList,link: '/accounting/purchase-requisitions' },
  { table: 'goods_receipt_notes',     label: 'Goods Receipt Notes',   icon: Package,      link: '/accounting/grn' },
  { table: 'ap_invoices',             label: 'AP Invoices',           icon: FileText,     link: '/accounting/ap-invoices' },
  { table: 'cheque_register',         label: 'Cheque Register',       icon: CreditCard,   link: '/accounting/cheque-register' },
  { table: 'bank_accounts',           label: 'Bank Accounts',         icon: Landmark,     link: '/accounting/bank-recon' },
  { table: 'bank_statement_lines',    label: 'Bank Statement Lines',  icon: Activity,     link: '/accounting/bank-recon' },
  { table: 'fixed_assets',            label: 'Fixed Assets',          icon: Package,      link: '/accounting/fixed-assets' },
...
const PHASE_ROADMAP = [
  ...
  {
    phase: 'Phase 4', label: 'Advanced Controls', status: 'planned' as const,
    items: [
      'Multi-currency revaluation journals',
      'Period-close checklist & automated lock',
      'Tax management (VAT / WHT)',
      'Sanctions screening integration',
      'SOD (Segregation of Duties) enforcement',
      'Budget encumbrance & commitment accounting',
      'Intercompany / inter-fund eliminations',
