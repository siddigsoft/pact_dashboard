  ...
  },
  {
    ...
    lines: [
      ...
      },
      {
        ...
        currency: 'fund.currency',
        glFunction: 'program',
        description: 'Cr encumbrance reserve — creates budget hold for committed spend',
      },
    ],
    notes: 'Fires on commitment transactions. Links to acct_budget_encumbrances via pre_fund_transactions.encumbrance_id. Account 2105 is standard encumbrance reserve; gl_liability_account is dynamic per fund.',
  },
  {
    id: 'pre_fund_paid',
    sourceTable: 'pre_fund_transactions',
    ...
    notes: 'Cash-flow model: disbursement reduces both the deferred liability and the bank balance. Expense recognition is handled by the linked operational module (cost_submissions / down_payment_requests) via pre_fund_transaction_id. If a commitment (pre_fund_committed) was raised earlier, the bridge engine also reverses it: Dr 2105 Encumbrance Reserve → Cr {gl_liability_account} for the committed amount.',
  },
  {
    id: 'pre_fund_closed',
