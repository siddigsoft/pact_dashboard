...
const PRE_FUNDING_TEMPLATES: PostingTemplate[] = [
  ...
  },
  {
    ...
    triggerCondition: "transaction_type = 'payment' INSERT — actual expenditure drawn from pre-fund",
    labelEn: 'Pre-Fund Payment — Recognise Expense',
    labelAr: 'دفعة من التمويل المسبق — الاعتراف بالمصروف',
    featureFlag: 'pre_funding',
    lines: [
      {
        accountCode: '{gl_liability_account}',
        ...
        currency: 'fund.currency',
        glFunction: 'program',
        description: 'Dr pre-fund liability — reduce deferred balance as spend is made',
      },
      {
        ...
        currency: 'fund.currency',
        glFunction: 'program',
        description: 'Cr programme expense account — recognise cost in P&L',
      },
    ],
    notes: 'Fires on every payment against an active pre-fund. Both accounts resolved dynamically from fund COA mapping so expenses land in the correct donor/project cost centre.',
  },
  {
    id: 'pre_fund_closed',
    ...
    triggerCondition: "pre_fund_reconciliations.status = 'closed' AND surplus_action IN ('return','split')",
    ...
    lines: [
      {
        ...
        currency: 'fund.currency',
        glFunction: 'program',
        description: 'Dr deferred liability for surplus amount being returned to donor',
      },
      {
        accountCode: '{gl_receipt_account}',
        accountName: 'Cash at Bank (resolved from fund.gl_receipt_account)',
        ...
        currency: 'fund.currency',
        glFunction: 'program',
        description: 'Cr bank — cash leaves for donor refund',
      },
    ],
    notes: 'Fires at period close when return_amount > 0. Both account codes resolved from fund mapping. Paired with pre_fund_carry_forward when surplus_action = split.',
  },
  {
