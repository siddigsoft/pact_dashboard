...
>(
  (
    ...
    // Get saved width from cookie or use default
    const getDefaultWidth = () => {
      if (typeof document !== 'undefined') {
        const cookies = document.cookie.split(';')
        const widthCookie = cookies.find(c => c.trim().startsWith(SIDEBAR_WIDTH_COOKIE_NAME))
        if (widthCookie) {
      ...
      return 208 // Default 13rem = 208px
    }
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden max-h-[calc(100dvh-4rem-env(safe-area-inset-bottom))]"
            style={
              {
