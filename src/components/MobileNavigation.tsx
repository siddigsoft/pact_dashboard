...
const MobileNavigation = () => {
  ...
  const secondaryNavItems: NavItem[] = [
    { icon: DollarSign, label: 'Finance', path: '/financial-operations', roles: ['admin' as AppRole, 'financialAdmin' as AppRole, 'fom' as AppRole] },
    ...
    { icon: TrendingUp, label: 'Budget', path: '/budget', roles: ['admin' as AppRole, 'financialAdmin' as AppRole, 'fom' as AppRole] },
