      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 pt-safe">
          ...
          <div className="absolute top-4 right-4 pt-safe">
            <Badge 
              variant="outline" 
              className="bg-green-500/20 text-green-400 border-green-500/40 gap-1.5"
            >
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-24 h-24 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center mb-4 shadow-xl">
              <img 
                src={PactLogo} 
                alt="PACT" 
                className="w-16 h-16"
            ...
            <h1 className="text-3xl font-bold text-white mb-1">PACT</h1>
