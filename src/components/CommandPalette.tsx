...
const ALL_PAGES: PageEntry[] = [
  ...
  { title: 'Recruitment / ATS', url: '/recruitment', icon: Briefcase, group: 'HR & People', keywords: ['recruitment', 'ats', 'candidate', 'hiring', 'job posting', 'interview'] },
  { title: 'Disciplinary & Grievance', url: '/disciplinary-tracking', icon: UserCog, group: 'HR & People', keywords: ['disciplinary', 'grievance', 'incident', 'warning', 'case'] },
  { title: 'Org Chart', url: '/org-chart', icon: FolderOpen, group: 'HR & People', keywords: ['org chart', 'organization', 'hierarchy', 'reports to', 'structure'] },
  { title: 'Benefits Administration', url: '/benefits-administration', icon: PieChart, group: 'HR & People', keywords: ['benefits', 'insurance', 'pension', 'health', 'enrollment'] },
  { title: 'Headcount Planning', url: '/headcount-planning', icon: CalendarCheck, group: 'HR & People', keywords: ['headcount', 'planning', 'forecast', 'staffing budget'] },
  ...
  return (
    <>
      <button
        ...
        className="flex h-8 w-full items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 text-[13px] text-slate-400 shadow-[0_1px_2px_rgb(15_23_42/0.06)] transition-colors hover:border-slate-300 hover:text-slate-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-500 dark:hover:border-slate-600 dark:hover:text-slate-300"
        data-testid="button-command-palette"
      >
        <Search className="h-3.5 w-3.5 shrink-0" />
        <span className="hidden flex-1 text-left sm:inline">Search</span>
        <kbd className="hidden h-5 items-center rounded border border-slate-200 bg-slate-50 px-1.5 font-mono text-[10px] text-slate-400 md:inline-flex dark:border-slate-700 dark:bg-slate-800 dark:text-slate-500">
          /
        </kbd>
      </button>
