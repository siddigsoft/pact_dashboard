...
interface DeadlineCountdownProps {
  targetDay: number; // The day of the month that is the deadline (e.g., 5)
}

export const DeadlineCountdown: React.FC<DeadlineCountdownProps> = ({ targetDay }) => {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium">
            {isPastDeadline ? "Next Deadline" : "Time Remaining"}
          </span>
        </div>
