...
export function PageInfoBanner({ title, description, workflowSteps, defaultOpen = false }: PageInfoBannerProps) {
              ...
              <div className="space-y-2" data-testid="workflow-steps">
                ...
                <div className="space-y-1.5">
                  {workflowSteps.map((step, idx) => (
                    <div key={step.step} className="flex items-start gap-2" data-testid={`workflow-step-${step.step}`}>
