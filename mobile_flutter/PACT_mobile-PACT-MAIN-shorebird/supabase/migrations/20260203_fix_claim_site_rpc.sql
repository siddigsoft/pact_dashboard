-- Fix claim_site_visit RPC to remove reference to non-existent claimed_by column
-- The mmp_site_entries table only has accepted_by/accepted_at columns, not claimed_by/claimed_at
...
GRANT EXECUTE ON FUNCTION public.claim_site_visit(UUID, UUID, NUMERIC, NUMERIC, TEXT, TEXT, TEXT) TO anon;
