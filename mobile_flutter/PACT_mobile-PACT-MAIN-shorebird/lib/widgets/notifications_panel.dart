...
class _BroadcastBannerWidgetState extends State<_BroadcastBannerWidget>
  ...
  void initState() {
    ...
    _shakeCtrl = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 55));
...
class _NotificationsPanelContentState
  ...
  void initState() {
    ...
    _notifications =
        widget.notificationService.currentNotifications.toList();
  ...
  int get _urgentUnread => _notifications
      .where(
          (n) => !n.isRead && n.isBroadcast && n.priority == 'urgent')
      .length;
  ...
  Future<void> _markAllRead() async {
    ...
    final ids =
        _filtered.where((n) => !n.isRead).map((n) => n.id).toList();
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Tab chips — broadcasts chip turns red when urgent unread > 0
                Row(
                  children: [
                    _tabChip('all', 'All / الكل', _unreadAll, false),
                    const SizedBox(width: 8),
                    _tabChip('broadcasts', '📢 Broadcasts',
                        _unreadBroadcasts, _urgentUnread > 0),
                    const SizedBox(width: 8),
                    _tabChip('updates', 'Updates', _unreadUpdates, false),
                  ],
                ),
              ],
            ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '$_urgentUnread urgent broadcast'
                      '${_urgentUnread > 1 ? 's' : ''}'
                      ' require your acknowledgment · تتطلب إقراراً',
                      style: GoogleFonts.poppins(
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
  ...
  // hasUrgent=true → chip and badge turn red
  Widget _tabChip(
      String id, String label, int unread, bool hasUrgent) {
    final isActive = _activeTab == id;
    final chipColor =
        hasUrgent ? AppColors.accentRed : const Color(0xFF6D28D9);
...
class _BroadcastCard extends StatefulWidget {
  ...
  const _BroadcastCard(
      {required this.notification, required this.onConfirm});
...
class _BroadcastCardState extends State<_BroadcastCard>
  ...
  void initState() {
    ...
    _shake = Tween<double>(begin: -4, end: 4)
        .animate(CurvedAnimation(parent: _shakeCtrl, curve: Curves.easeInOut));
  ...
  void _copyToClipboard(BuildContext context) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Copied to clipboard / تم النسخ',
            ...
            boxShadow: [
              BoxShadow(
                color: isUrgent && !isRead
                    ? _priorityColor.withValues(alpha: 0.14)
            ...
            children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _priorityColor.withValues(alpha: 0.07),
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                            color:
              ...
              if (!isRead)
                Padding(
                  ...
                  child: isUrgent
                      ? _SwipeToConfirm(
                          color: _priorityColor, onConfirm: _confirm)
                      : GestureDetector(
                          onTap: _confirm,
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 200),
    ...
    return LayoutBuilder(builder: (ctx, constraints) {
      ...
      return GestureDetector(
        onHorizontalDragUpdate: (d) {
          ...
          setState(() {
            _progress = ((_progress * maxDrag + d.delta.dx) / maxDrag)
                .clamp(0.0, 1.0);
          });
        },
          ...
          child: Stack(
            children: [
              ...
              AnimatedContainer(
                ...
                width: (_progress * maxDrag + thumbSize + 4)
                    .clamp(thumbSize + 4, trackWidth),
