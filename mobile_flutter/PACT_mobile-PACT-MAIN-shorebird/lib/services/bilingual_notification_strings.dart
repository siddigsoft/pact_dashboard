class BilingualNotificationStrings {
  ...
  static String costSubmissionApprovedBody(String siteVisitId, double amount, String currency) =>
  ...
  static String budgetAlertBody(String siteVisitId, double remaining, String currency) =>
  ...
  static String get walletUpdatedTitle =>
      'Wallet Updated | تم تحديث المحفظة';
  ...
  static String get missedCallTitle =>
  ...
  static String get permitRejectedTitle =>
      'Permit Rejected | تم رفض التصريح';
