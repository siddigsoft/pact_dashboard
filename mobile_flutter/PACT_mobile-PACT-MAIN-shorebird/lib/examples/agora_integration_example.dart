...
class IncomingCallListenerExample extends StatefulWidget {
  ...
  @override
  State<IncomingCallListenerExample> createState() => _IncomingCallListenerExampleState();
}

class _IncomingCallListenerExampleState extends State<IncomingCallListenerExample> {
  ...
  void _showIncomingCallDialog(AgoraIncomingCall incomingCall) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Incoming ${incomingCall.isAudioOnly ? "Audio" : "Video"} Call'),
        content: Column(
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      body: Center(
        child: Text('Listening for incoming calls...'),
      ),
    );
  }
}
...
class CallStateListenerExample extends StatefulWidget {
  ...
  @override
  State<CallStateListenerExample> createState() => _CallStateListenerExampleState();
}
...
class QuickCallButton extends StatelessWidget {
  ...
  Future<void> _startCall(BuildContext context) async {
    ...
    if (result.success && result.channelName != null && context.mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to start call: ${result.error ?? "Unknown error"}')),
      );
    }
  }
}
